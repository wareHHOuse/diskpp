...
void JacobianFirstDerivate( const static_matrix< T, DIM, DIM > &M ) {
    static_assert( ( DIM == 2 || DIM == 3 ),
                   "Can not compute jacobian derivate for this dimension" );
}

template < typename T >
static_matrix< T, 2, 2 > JacobianFirstDerivate( const static_matrix< T, 2, 2 > &M ) {
...
template < typename T >
static_matrix< T, 3, 3 > JacobianFirstDerivate( const static_matrix< T, 3, 3 > &M ) {
...
template < typename T, int DIM >
void JacobianSecondDerivate( const static_matrix< T, DIM, DIM > &M ) {
    static_assert( ( DIM == 2 || DIM == 3 ),
                   "Can not compute jacobian derivate for this dimension" );
}

template < typename T >
static_tensor< T, 2 > JacobianSecondDerivate( const static_matrix< T, 2, 2 > &M ) {
...
template < typename T >
static_tensor< T, 3 > JacobianSecondDerivate( const static_matrix< T, 3, 3 > &M ) {
