...
foreach(extra IN LISTS MUMPS_EXTRAS)
    ...
    if(MUMPS_${extra_upper}_LIBRARY)
        add_library(MUMPS::${extra_upper} STATIC IMPORTED)
...
if (MUMPSS_INCLUDE_DIR AND MUMPSS_LIBRARY)
    add_library(MUMPS::S STATIC IMPORTED)
...
if (MUMPSD_INCLUDE_DIR AND MUMPSD_LIBRARY)
    add_library(MUMPS::D STATIC IMPORTED)
...
if (MUMPSC_INCLUDE_DIR AND MUMPSC_LIBRARY)
    add_library(MUMPS::C STATIC IMPORTED)
...
if (MUMPSZ_INCLUDE_DIR AND MUMPSZ_LIBRARY)
    add_library(MUMPS::Z STATIC IMPORTED)
