...
template< typename T>
void test_hexahedra_diskpp(const run_params& rp)
{
   size_t runs = 4;
...
template< typename T>
void test_hexahedra_fvca6(const run_params& rp)
{
   size_t runs = 4;
...
template< typename T>
void test_tetrahedra_netgen(const run_params& rp)
{
   size_t runs = 4;
...
template< typename T>
void test_polyhedra_fvca6(const run_params& rp)
{
   size_t runs = 3;
...
template< typename T>
void test_tetrahedra_fvca6(const run_params& rp)
{
   size_t runs = 4;
