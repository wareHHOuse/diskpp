                    ...
                    const typename MeshType::coordinate_type& eta)
{
    ...
    for (size_t i = mindeg; i <= maxdeg; i++)
    {
        ...
        for (auto& tsp : paths)
        {
            ...
            auto error_full = run_signorini(msh, ap, eta);
...
void test_triangles(test_type tt, algorithm_parameters<double>& ap, const double& eta)
{
    ...
    paths.push_back("../../../diskpp/meshes/2D_triangles/netgen/square_tri1_big.mesh2d");
    paths.push_back("../../../diskpp/meshes/2D_triangles/netgen/square_tri2_big.mesh2d");
    paths.push_back("../../../diskpp/meshes/2D_triangles/netgen/square_tri3_big.mesh2d");
