...
// ../wave_propagation -k 1 -s 0 -r 0 -c 1 -p 0 -l 2 -n 350 -f 0 -e 0
// BE CAREFUL ON THE CHOICE OF THE WEIGHTING IN FRONT OF THE STAB: elastoacoustic_four_field.hpp
...
void EHHOFirstOrderCFL(int argc, char **argv) {
    ...
    for (auto & cell : msh ) {
        ...
        mesh_type::point_type bar = barycenter_bis(msh, cell);
