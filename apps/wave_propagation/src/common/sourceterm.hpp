...
public:
    ...
    static double ricker_fluid(size_t it, double dt){
    ...
    // Punctual Source
    static Matrix<double, Dynamic, 1> punctual_source(size_t it, double dt, std::pair<typename Mesh::point_type,size_t> & pt_cell_index, Mesh & msh, disk::hho_degree_info & hho_di, Matrix<double, Dynamic, 1> & x_dof){
