...
if(NOT MUMPS_LIBRARIES)
  ...
  if(MUMPSS_LIBRARY)
    message("Real single precision MUMPS found.")
  ...
  if(MUMPSD_LIBRARY)
    message("Real double precision MUMPS found.")
  ...
  if(MUMPSC_LIBRARY)
    message("Complex single precision MUMPS found.")
  ...
  if(MUMPSZ_LIBRARY)
    message("Complex precision MUMPS found.")
    list(APPEND MUMPS_LIBRARIES ${MUMPSZ_LIBRARY})
  endif()
  find_library(MUMPS_COMMON_LIBRARY NAMES ${__MUMPS_COMMON_NAMES} ${_MUMPS_SEARCH_OPTS} PATH_SUFFIXES lib lib64)
  if(MUMPS_COMMON_LIBRARY)
    list(APPEND MUMPS_LIBRARIES ${MUMPS_COMMON_LIBRARY})
  endif()
  find_library(MUMPS_MPISEQ_LIBRARY NAMES ${__MPISEQ_NAMES} ${_MUMPS_SEARCH_OPTS} PATH_SUFFIXES lib lib64)
