...
template<typename T>
class quadrature<hexahedral_mesh<T>, typename hexahedral_mesh<T>::cell>
{
    std::vector<std::pair<point<T,1>, T>> m_quadrature_data;

public:
    typedef hexahedral_mesh<T>                      mesh_type;
...
template<typename T>
class quadrature<hexahedral_mesh<T>, typename hexahedral_mesh<T>::face>
{
    std::vector<std::pair<point<T,1>, T>> m_quadrature_data;
