...
class LinearLaw_cell
{
  ...
  public:
                        ...
                        const material_type&               material_data) const
    {
        ...
        const int  grad_basis_size = revolution::matrix_basis_size(grad_degree, dimension, dimension);
        auto       gb              = revolution::make_matrix_monomial_basis(msh, cl, grad_degree);
